...
import { DocumentDraft99Component } from 'app/entities/document-draft-99/document-draft-99.component';
...
describe('Component Tests', () => {
    describe('DocumentDraft99 Management Component', () => {
        let comp: DocumentDraft99Component;
        let fixture: ComponentFixture<DocumentDraft99Component>;
        let service: DocumentDraft99Service;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Draft99App1TestModule],
                declarations: [DocumentDraft99Component],
                providers: [
                    {
                ...
                .overrideTemplate(DocumentDraft99Component, '')
                .compileComponents();

            fixture = TestBed.createComponent(DocumentDraft99Component);
