...
import { ProjectDraft99Component } from 'app/entities/project-draft-99/project-draft-99.component';
...
describe('Component Tests', () => {
    describe('ProjectDraft99 Management Component', () => {
        let comp: ProjectDraft99Component;
        let fixture: ComponentFixture<ProjectDraft99Component>;
        let service: ProjectDraft99Service;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Draft99App1TestModule],
                declarations: [ProjectDraft99Component],
                providers: [
                    {
                ...
                .overrideTemplate(ProjectDraft99Component, '')
                .compileComponents();

            fixture = TestBed.createComponent(ProjectDraft99Component);
